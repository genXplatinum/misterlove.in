...
export const pieces = [
  ...
  },
  {
    ...
    status: 'Complete',
    accent: 'cobalt',
    // One book, one download: the complete sixteen parts, bound.
    pdf: 'wars-of-punjab.pdf',
    pdfSize: '15.7 MB',
    pdfLabel: 'The complete book',
